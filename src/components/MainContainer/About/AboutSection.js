      ...
      <div className="row">
          ...
          <div className="col-md-6">
              ...
              <div className="m-bottom-30">
                  <h2 className="mb-4">About Our Agency</h2>
                  <div className="divider-small wow zoomIn" data-wow-duration="1s" data-wow-delay="0.7s"></div>
              </div>
              <div className="wow fadeInRight">
                  <p>We are the local agency for businesses or individuals of Bhilai and durg. We built ServeServer to provide digital identity to anyone who wants to take themselves or their business locally and on the national level. 
                  ...
                  <p>Our team is filled with skilled, talented, and capable developers who can shape your ideas to live by building modern apps which represent your business. At ServeServer, we not only provide you 
