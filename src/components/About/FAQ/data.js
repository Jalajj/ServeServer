...
const data = {
    ...
    rows: [
      ...
      },
      {
        ...
        content: "Yes, we also provide design services. Even if you don't have a design in mind, we covered you."
      },
      {
        title: "Where do ServeServer office reside in Bhilai?",
        content:
          "Currently, we don't operate from any office, but you can check the contact section for our temporary address."
      },
      {
